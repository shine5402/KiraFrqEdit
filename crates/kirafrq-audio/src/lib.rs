//! WAV decode and normalization: PCM via hound, downmixed to mono and
//! resampled to 44.1 kHz via rubato (#5; research in
//! `docs/research/wav-decode-resample.md`).
//!
//! Input is normalized to the mono 44.1 kHz timeline the table formats
//! assume; non-44.1 kHz, non-16-bit and non-mono input is processed
//! best-effort and warned per file (#11). This crate hands callers plain
//! samples: WORLD stays in `kirafrq-world-binding` and the table formats in
//! `kirafrq-formats`.
