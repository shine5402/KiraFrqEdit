//! Contract for `frqgen::generate`, `frqgen::generate_wavs` and
//! `frqgen::plan` over the settled policy set, exercised on real wavs in
...
use frq_core::{FrequencyTable, frq, mrq};
use frqgen::{
