//! Structural contract for `kirafrq_formats::mrq` — the seven points of #10's
...
use kirafrq_formats::FrequencyTable;
use kirafrq_formats::mrq::{self, Desc, DescError, Entry, MergeState, Sharing};
