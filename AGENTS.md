...
- 2026-09: research phase done; workspace scaffold landed (#15): five crates under `crates/`,
  ...
  `.github/workflows/`. The core formats, WAV normalization and the generation pipeline have
  landed; next are the CLI (#20), the GUI (#23) and end-to-end validation (#22).
