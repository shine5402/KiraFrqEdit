...
All frequency-table formats share one in-memory model — `kirafrq_formats::FrequencyTable`
...
- `kirafrq-formats` takes no position on how f0 was estimated, so it stays free of the
